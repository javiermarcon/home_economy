...
# (str) Package name
package.name = HomeEconomy

# (str) Package domain (needed for android/ios packaging)
package.domain = org.homeeconomy
...
version.regex = current_version = (.*)
version.filename = .bumpversion.cfg

# (list) Application requirements
# comma seperated e.g. requirements = sqlite3,kivy
requirements = python2, kivy, sqlite3, passlib, pytest, SQLAlchemy, incremental, twisted, lxml, pycrypto, future, KivyCalendar, openssl, requests, mock, argparse, os, site, copy
