...
class IdTreeViewLabel(TreeViewLabel):
...
class TreeViewDb(BoxLayout):
    ...
    def populate_treeview(self, tv, selected_id=None):
        """
        Llena el tree view
        ...
        if self.dbparentclass:
            ...
            for act in tipos_cuenta:
                ...
                nodo = tv.add_node(IdTreeViewLabel(text=txt_act, value=act.id, is_open=True))
